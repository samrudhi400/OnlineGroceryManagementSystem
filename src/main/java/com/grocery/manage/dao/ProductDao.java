...
public class ProductDao {
	...
	public Product checkIdOrName(int id) {
...
////////	// check User password by user_name
	...
	public void delete(String name, String shop_name) {
		this.pr.deleteByNameAndShop_name(name, shop_name);
	...
	//find product by id
	public Product findPrdByid(int id) {
		Product p = new Product();
