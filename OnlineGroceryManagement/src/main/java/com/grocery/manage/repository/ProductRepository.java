...
public interface ProductRepository extends JpaRepository<Product, Integer> {
	...
	@Query(value = "select * from product where shop_name = ?1" , nativeQuery = true)
	...
	@Transactional
	@Modifying
	@Query(value = "DELETE FROM product WHERE name=?1 and shop_name=?2" ,nativeQuery = true)
	public void deleteByNameAndShop_name(String name, String shop_name);
